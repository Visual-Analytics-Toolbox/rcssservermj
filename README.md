...
- T1 and K1 robot XMLs and assets adapted / taken from [booster_assets](https://github.com/BoosterRobotics/booster_assets/blob/main/robots/) (BSD 3-Clause License)
